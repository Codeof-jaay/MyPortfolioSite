...
const Resume = () => {
  return (
  <div
      className="flex flex-col md:flex-row items-center gap-5 w-3xl mb-10 md:space-x-10" >
      <a className="w-sm md:w-full " href="/Resume.pdf" download style={{ textDecoration: 'none' }}>
